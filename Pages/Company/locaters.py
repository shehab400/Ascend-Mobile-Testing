...
class CompanyPageLocators:
    ...
    CHOSEN_COMPANY_TO_EDIT_BUTTON = (By.ANDROID_UIAUTOMATOR, 'new UiSelector().className("android.widget.Button").instance(4)')
    ...
    CHOSEN_COMPANY_TO_ADD_JOB_BUTTON = (By.ACCESSIBILITY_ID, 'attack on titan\nanime\njapan')
    ADD_JOB_BUTTON = (By.ANDROID_UIAUTOMATOR, 'new UiSelector().className("android.widget.Button").instance(1)')
